      ...
      <main className="w-full max-w-md mx-auto px-6 py-16">
        <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-100">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 font-body text-sm">Acesse sua conta para gerenciar eventos</p>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              disabled={loading}
              className="w-full bg-white hover:bg-gray-50 border-2 border-gray-200 hover:border-gray-300 text-gray-700 font-medium px-6 py-3.5 rounded-xl transition-all flex items-center justify-center gap-3 disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-black hover:bg-gray-900 text-white font-medium px-6 py-3.5 rounded-xl transition-all flex items-center justify-center gap-3 disabled:opacity-50"
            >
          ...
          <form onSubmit={handleEmailLogin} className="space-y-5">
            ...
            <button 
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-primary to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold px-6 py-3.5 rounded-xl shadow-lg hover:shadow-xl transition-all font-title mt-2 disabled:opacity-50"
            >
              {loading ? (
                <>
