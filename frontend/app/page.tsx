      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-white to-blue-50 py-20 lg:py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-title font-bold text-gray-900 mb-6 leading-tight">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-3xl sm:text-4xl font-title font-bold mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            <div className="group bg-white border-2 border-gray-100 p-8 rounded-2xl hover:border-primary/20 hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-xl font-title font-semibold mb-3 group-hover:text-primary transition-colors">
                Gestão Simplificada
              </h4>
      ...
      <section className="py-20 bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-title font-bold mb-4">Plano Simples e Transparente</h3>
            <p className="text-gray-600">Tudo que você precisa para vender ingressos online</p>
          </div>

          <div className="max-w-lg mx-auto bg-white rounded-2xl shadow-xl p-8 border-2 border-primary">
            <div className="text-center mb-6">
              <h4 className="text-2xl font-title font-bold mb-2">Plano Organizador</h4>
